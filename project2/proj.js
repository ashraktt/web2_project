window.addEventListener("load",function(){
  let x= { type : 'load project page' , target : 'show page ' , time_date : new Date()}
...
window.addEventListener("unload",function(){
  let y= { type : 'unload project page' , target : 'close page ' , time_date : new Date()}
  ...
  document.body.removeChild(document.getElementById("img") );
    ...
    for (i = 0; i < num; i++)
    {
      ...
      for(var i=0 ;i<t.length;i++)
      {
        ...
        localStorage.setItem('L_click '+ e.target.textContent,JSON.stringify(a));
